...
const DEFAULT_SERVICES: Service[] = [
  {
    ...
    categoryId: "1",
    name: "Hair Cutting",
    image: "https://images.unsplash.com/photo-1562322140-8baeefefd46b?w=400&h=300&fit=crop",
    price: 1500,
    duration: "45 min",
  ...
  },
  {
    ...
    price: 5000,
    duration: "120 min",
    description: "Smooth, frizz-free hair with keratin",
    popular: false,
    enabled: true,
  },
  {
    ...
    price: 3000,
    duration: "60 min",
    description: "Glamorous party-ready makeup look",
    popular: true,
    enabled: true,
  },
  {
  ...
  },
  {
    ...
    price: 3000,
    duration: "90 min",
    description: "Smooth, painless full body waxing",
    popular: false,
    enabled: true,
  },
  {
    ...
    price: 35000,
    duration: "5 hours",
    description: "Complete bridal package with makeup, hair, mehndi & more",
    popular: true,
    enabled: true,
  },
];
...
export function saveRequests(reqs: BookingRequest[]) {
  save("salon_requests", reqs);
}
